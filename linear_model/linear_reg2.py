...
# -*- coding: utf-8 -*-
"""
/Users/charleslai/PycharmProjects/ml_scratch/linear_model.linear_reg2.py was created on 2019/03/05.
...
class LinearRegression():
    ...
    def __init__(self, n_iterations=10, learning_rate=0.001, regularization=None, gradient=True):
...
def main():
    ...
    model = LinearRegression(learning_rate=0.1, n_iterations=10,)
