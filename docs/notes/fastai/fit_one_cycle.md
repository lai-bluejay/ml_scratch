...
他在实验过程中观察到的是，在Cycle中期，高学习率将作为正则化的角色，并使NN不会过拟合。它们将阻止模型落在损失函数的陡峭区域，而是找到更平坦处的最小值。他在[另一篇论文](https://arxiv.org/abs/1708.07120)中解释了通过使用这一政策，Hessian的近似值较低，表明SGD正在寻找更宽的平坦区域。
...
来自Tencent AI Lab的大佬沈力有一天这样教育群友：
>**Dropout的缺点**
...
```
![find_lr](images/lesson1/find_lr.png)
...
![onecycle_lr_变化](images/lesson1/onecycle_params.png)
...
```
![exp1_95_lrs](images/lesson1/exp1_95_lr_changes.png)![exp1_95_losses](images/lesson1/exp1_95_losses.png)
...
![big_lr](images/lesson1/exp2_big_lr.png)
...
![exp5_wds](images/lesson1/exp5_wds.png)
